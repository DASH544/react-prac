...
import { SlideRight } from '../../utils/animate.js'
const Hero = () => {
  return (
  <>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center  py-16 md:pr-16 xl:pr-40 md:py-0'>
        <div className='text-center md:text-left space-y-6'>
          ...
          <motion.h1 
           ...
           initial="hidden"
           animate="visible"
          className='text-5xl font-semibold lg:text-6xl leading-tight'>Find Your Perfect <span className='text-orange-500'>Tutor</span></motion.h1>
          <motion.p
           variants={SlideRight(0.4)}
           initial="hidden"
           animate="visible"
          ...
          <button className='bg-yellow-400 font-semibold text-white px-6 py-3  rounded-full '>Get Started</button>
          <button className='flex items-center justify-center'>
            <span className='flex items-center justify-center rounded-full w-10 h-10 bg-gray-300/25'><FaPlay className='text-blue-500'/></span>
